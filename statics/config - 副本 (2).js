...
var zhaoff = {
    ...
    logo2:'/statics/images/logo.gif',
    logo3:'/statics/images/logo.gif',
    title:'-1PK.COM',//html标签名-1PK.COM
    keywords:'-1PK.COM',
    description:'-1PK.COM',
    head_left_title:'主站域名:[传奇圈]-www.1PK.COM',//网站左侧展示内容
    head_center_advert:'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;网站数据匀采集互联网,如发现跑路服,涉及诈骗,赌博等违法行为请联系我们举报QQ：889787 ',//网站中间公告
    first_title:[//一级标题功能参数配置['一级功能名称'，'一级功能名称（小）','url=false提示正在开发中',true:显示热门|false:默认不显示,['index']=默认选中的]
      ['首页','首页','/index.html',false,['index','']],
      ['广告排行','广告排行','/code/ranking.html',false,['ranking']],
      ['手游排行','手游排行','/code/phoneRank.html',false,['phoneRank']],
      ['全网广告','全网广告','/code/allAdvertisements.html',false,['allAdvertisements']],
      ['黑名单','黑名单','/code/report.html',true,['report','']],
      ['招聘交易','招聘交易','/code/recruTran.html',true,['recruTran','recruTran_edit']],
      ['玩家交流','玩家交流','/code/forumFunction.html',true,['forumFunction','forumFunction_edit']],
      ['玩家群.主播','玩家群.主播','/code/playerGroup.html',false,['playerGroup']],
      ['品牌大服','品牌大服','/code/ppdf.html',true,['ppdf','']],
      ['新闻公告','新闻公告','/code/journalism.html',false,['journalism']],
      ['发布站点','发布站点','/code/publishSites.html',false,['publishSites']],
      ['工具导航','工具导航','/code/resourceNavigation.html',false,['resourceNavigation']]
    ],
    ...
    jyxqms:' *联系卖家时，请说是在CQQ网站上看到的，谢谢！',
    jywxts:'<span>温馨提示：</span>请务必进行平台担保交易，切勿线下交易，谨防上当受骗！ 找服服网站为您保障交易安全！',
    ...
    tzeditqr:'/statics/images/wx.png' //帖子详情右侧二维码
...
if (flag && htmlid != "wz"&&htmlid!='brand'){
    document.write(
        ...
        '	hm.src = "https://hm.baidu.com/hm.js?9556469f709dc7241468870606003272";'+
